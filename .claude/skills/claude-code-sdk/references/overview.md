...
description: Build production AI agents with Claude Code as a library. Use when the user wants to create autonomous agents that can read files, run commands, search the web, edit code, and more using the Agent SDK.
...
## API-KEY 配置
翟千祎的 mimo token plan 配置如下：
API_ENV = {
    "ANTHROPIC_BASE_URL": "https://token-plan-cn.xiaomimimo.com/anthropic",
    "ANTHROPIC_AUTH_TOKEN": "tp-cxq9g672kqgmcpmgvzhktpk7vucswrn9atq4i4ehwyxc6ngl",
